...
CATALOGUE = [
    ...
    {"group": "Harness drivers (B3 · HarnessDriver)", "id": "agentic_overlay", "name": "Agentic overlay (adaptive)",
     "seam": "HarnessDriver", "kind": "builtin", "wired": True, "cite": "adapters/drivers/overlay_driver.py (--driver overlay)"},
    {"group": "Harness drivers (B3 · HarnessDriver)", "id": "pyrit", "name": "Microsoft PyRIT",
     "seam": "HarnessDriver", "kind": "optional-pip", "wired": True, "extra": "redteam", "modules": ["pyrit"],
     "cite": "adapters/drivers/pyrit_driver.py (--driver pyrit)"},
    {"group": "Harness drivers (B3 · HarnessDriver)", "id": "garak", "name": "NVIDIA Garak probes",
     ...
     "cite": "adapters/drivers/garak_driver.py (needs served target)"},
    {"group": "Harness drivers (B3 · HarnessDriver)", "id": "inspect_ai", "name": "Inspect AI eval substrate",
     "seam": "HarnessDriver", "kind": "optional-pip", "wired": True, "extra": "eval", "modules": ["inspect_ai"],
     "cite": "adapters/drivers/inspect_driver.py (--driver inspect)"},
    {"group": "Harness drivers (B3 · HarnessDriver)", "id": "nemo_guardrails", "name": "NVIDIA NeMo Guardrails",
     ...
     "cite": "adapters/drivers/nemo_driver.py (needs live LLM)"},
